...
new d}})};if(h){try{a=require("./wind")}catch(k){a=require("wind")}i()}else if(b)require(["wind"],function(b){a=b;i()});else{b=Function("return this")();if(!b.Wind)throw Error('Missing the root object, please load "wind" component first.');a=b.Wind;i()}})();
