...
{};var a=b.Binding;b.Windify=a;a.fromStandard=x;a.fromCallback=y}})};if(n){try{h=require("./wind")}catch(z){h=require("wind")}o()}else if(l)require(["wind"],function(b){h=b;o()});else{l=Function("return this")();if(!l.Wind)throw Error('Missing the root object, please load "wind" component first.');h=l.Wind;o()}})();
