(function(){var d,k=function(a){return a._typeId=="670a1076-712b-4edd-9b70-64b152fe1cd9"},h=function(){};h.prototype={isTypeOf:k,_typeId:"670a1076-712b-4edd-9b70-64b152fe1cd9",message:"The task has been cancelled."};var f=Function("return this")();if(f.__wind__async__taskIdSeed===void 0)f.__wind__async__taskIdSeed=0;var l=function(){};l.prototype={register:function(a){this.isCancellationRequested&&a();if(!this._handlers)this._handlers=[];this._handlers.push(a)},unregister:function(a){this._handlers&&
(a=this._handlers.indexOf(a),a>=0&&this._handlers.splice(a,1))},cancel:function(){if(!this.isCancellationRequested){this.isCancellationRequested=!0;var a=this._handlers;delete this._handlers;for(var c=0;c<a.length;c++)try{a[c]()}catch(b){d.logger.warn("[WARNING] Cancellation handler threw an error: "+b)}}},throwIfCancellationRequested:function(){if(this.isCancellationRequested)throw new h;}};var e=function(a){this.id=++__wind__async__taskIdSeed;this._delegate=a;this._listeners={};this.status="ready"};
