...
dependencies:{builderbase:"~0.7.0"},init:function(){h=f._;h.each(f.BuilderBase.prototype,function(a,b){o.prototype[a]=b});f.Async=j;f.binders.async="$await";f.builders.async=new o}})};if(p){try{f=require("./wind-core")}catch(x){f=require("wind-core")}q()}else if(l)require(["wind-core"],function(a){f=a;q()});else{l=Function("return this")();if(!l.Wind)throw Error('Missing the root object, please load "wind" component first.');f=l.Wind;q()}})();
