(function(){var f,h,j={},q=function(a){return a._typeId=="670a1076-712b-4edd-9b70-64b152fe1cd9"},m=j.CanceledError=function(){};m.prototype={isTypeOf:q,_typeId:"670a1076-712b-4edd-9b70-64b152fe1cd9",message:"The task has been cancelled."};var r=j.AggregateError=function(a){this.children=[];if(a)for(var b=0;b<a.length;b++)this.children.push(a[b])};r.prototype={_typeId:"4a73efb8-c2e2-4305-a05c-72385288650a",message:"This is an error contains sub-errors, please check the 'children' collection for more details.",
...
"normal"||a=="return")c.complete("success",b);else if(a=="throw")c.complete("failure",b);else throw Error("Unsupported type: "+a);})})},Bind:function(a,b){return{next:function(c,d){var e=function(){if(this.error)d("throw",this.error);else{var a;try{a=b.call(c,this.result)}catch(e){d("throw",e);return}a.next(c,d)}};a.status=="ready"?(a.addEventListener("complete",e),a.start()):a.status=="running"?a.addEventListener("complete",e):e(a)}}}};var l=j.Binding={},t=function(a,b){for(var c=[],d=0;d<a.length;d++)c.push(a[d]);
for(;c.length<b;)c.push(void 0);return c},u=function(a){if(a.length<=1)return null;for(var b=[],c=1;c<a.length;c++)b.push(a[c]);return b};l.fromStandard=function(a){var b=u(arguments);return function(){var c=this,d=t(arguments,a.length-1);return i.create(function(e){d.push(function(a,c){if(a)e.complete("failure",a);else if(b){for(var d={},f=0;f<b.length;f++)d[b[f]]=arguments[f+1];return e.complete("success",d)}else e.complete("success",c)});a.apply(c,d)})}};l.fromCallback=function(a){var b=u(arguments);
return function(){var c=this,d=t(arguments,a.length-1);return i.create(function(e){d.push(function(a){if(b){for(var c={},d=0;d<b.length;d++)c[b[d]]=arguments[d];e.complete("success",c)}else e.complete("success",a)});a.apply(c,d)})}};var v=!!(typeof require==="function"&&typeof module!=="undefined"&&module.exports);l=!!(typeof require==="function"&&typeof define==="function"&&define.amd);var p=function(){f.define({name:"async",version:"0.7.0",require:v&&require,autoloads:["builderbase"],dependencies:{builderbase:"~0.7.0"},
init:function(){h=f._;h.each(f.BuilderBase.prototype,function(a,b){o.prototype[a]=b});f.Async=j;f.binders.async="$await";f.builders.async=new o}})};if(v){try{f=require("./wind-core")}catch(x){f=require("wind-core")}p()}else if(l)require(["wind-core"],function(a){f=a;p()});else{l=Function("return this")();if(!l.Wind)throw Error('Missing the root object, please load "wind" component first.');f=l.Wind;p()}})();
