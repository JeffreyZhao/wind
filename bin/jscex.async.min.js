...
1)}};var f=function(){};f.prototype={binder:"$await",Start:function(a,b){return new d({onStart:function(c){b.next(a,function(a,b){if(a=="normal"||a=="return")c("success",b);else if(a=="throw")c("failure",b);else throw Error("Unsupported type: "+a);})}})},Bind:function(a,b){return{next:function(c,e){var d=function(d){if(d.status=="succeeded"){var f;try{f=b.call(c,a.result)}catch(g){e("throw",g);return}f.next(c,e)}else e("throw",a.error)};a.status=="ready"?(a.addListener(d),a.start()):a.status=="running"?
a.addListener(d):d(a)}}}};for(var h in Jscex.builderBase)f.prototype[h]=Jscex.builderBase[h];return{CancellationToken:g,CanceledError:e,Task:d,Builder:f}}();Jscex.builders.async=new Jscex.Async.Builder;
