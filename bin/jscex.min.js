...
this.d.i=c;a[0]=="block"&&this.a(" ");this.a("while (").b(b).a(");")},"if":function(a){var b=a[1],c=a[2];this.a("if (").b(b).a(") ").o(c);if(a=a[3])c[0]=="block"?this.a(" "):this.a(""),a[0]=="if"?this.a("else ").b(a):this.a("else ").o(a)},"break":function(a){this.d.i||this.d.G?this.a("break;"):this.a("return ").g({type:"break",e:a}).a(";")},"continue":function(a){this.d.i?this.a("continue;"):this.a("return ").g({type:"continue",e:a}).a(";")},"throw":function(a){var b=this.d;b.H||b.A?this.a("throw ").b(a[1]).a(";"):
