Jscex=function(){function f(a){this.n=a;this.h=Jscex.builders[a].binder;this.f=!1}var e=0;f.prototype={b:function(a){this.l.push(a);return this},p:function(a){this.l=[];var b=a[3];this.b("function ("+a[2].join(", ")+") {");this.b("var $_builder_$ = Jscex.builders["+JSON.stringify(this.n)+"];");this.b("return $_builder_$.Start(this, function () {");this.d(b);this.b("});");this.b("}");return this.l.join("")},o:function(a){var b=a[0];if(b=="stat"){if(b=a[1],b[0]=="call"){var c=b[1];if(c[0]=="name"&&
c[1]==this.h)return{j:b[2][0],g:"",k:!1}}}else if(b=="var"){if(a=a[1],a.length==1&&(b=a[0],a=b[0],(b=b[1])&&b[0]=="call"))if(c=b[1],c[0]=="name"&&c[1]==this.h)return{j:b[2][0],g:a,k:!1}}else if(b=="return"&&(b=a[1])&&b[0]=="call")if(c=b[1],c[0]=="name"&&c[1]==this.h)return{j:b[2][0],g:"$$__$$__",k:!0};return null},d:function(a,b){arguments.length<=1&&(b=0);if(b>=a.length)return this.b("return $_builder_$.Normal();"),this;var c=a[b],d=this.o(c);d?(this.b("return $_builder_$.Bind(").c(d.j).b(", function ("+
...
throw_n:function(a){this.b("throw ").c(a[1]).b(";")},conditional:function(a){this.b("(").c(a[1]).b(") ? ("+a[2]+") : (").c(a[3]).b(")")},"try":function(a){this.b("$_builder_$").b(".Try(");this.b("$_builder_$.Delay(function () {");this.d(a[1]);this.b("}),");var b=a[2];b?(this.b("function ("+b[0]+") {"),this.d(b[1]),this.b("}, ")):this.b("null,");(a=a[3])?(this.b("function () {"),this.d(a),this.b("}")):this.b("null");this.b(")")},try_n:function(a){this.b("try {");this.e(a[1]);var b=a[2];a=a[3];b&&(this.b("} catch ("+
b[0]+") {"),this.e(b[1]));a&&(this.b("} finally {"),this.e(a));this.b("}")},defun:function(a){this.m(a)},"function":function(a){this.m(a)},"switch":function(){}}};return{compile:function(a,b){var c=UglifyJS.parse("var f = "+b.toString()+";")[1][0][1][0][1];return"("+(new f(a)).p(c)+")"},builders:{}}}();
